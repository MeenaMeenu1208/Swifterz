...
public class utilClass {
	...
	public static String readProperty(String key) throws Exception {
		...
		File file = new File("C:\\Users\\ZynoSure\\Desktop\\Meena\\Eclipse\\eclipse\\SwifterzProject\\Properties");
	...
	public static Object[][] dataReader(String sheetName) throws Exception {
		...
		XSSFWorkbook workBook = new XSSFWorkbook(excelPath + "/Excel/SwifterzExcelData.xlsx");
